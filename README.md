...
Running `python -m afes_venus_jax.examples.t42l60_venus_dry_diurnal` for the default 500 steps (≈3.47 model days) produces the following domain-wide extrema at the final step:

- Zonal wind **u**: min ≈ −339 m/s, max ≈ 228 m/s
- Meridional wind **v**: min ≈ −472 m/s, max ≈ 413 m/s
